...
{ 
	...
	/* A recursive function to get the sum of values in given range of the array. The following are parameters for 
		this function. 
	...
	int getSumUtil(int ss, int se, int qs, int qe, int si){ 
		...
		// At this point sure, pending lazy updates are done for current node. So we can return value (same as 
	...
	/* A recursive function that constructs Segment Tree for array[ss..se]. si is index of current node in segment 
	tree st. */
	void constructSTUtil(int arr[], int ss, int se, int si){ 
		...
		/* If there are more than one elements, then recur for left and right subtrees and store the sum 
